...
public class CaptureHelpers extends ScreenRecorder {
    ...
    public static void captureScreenshot(WebDriver driver, String screenName) {
        ReadConfigPropertyFile.setPropertiesFile();
        try {
            ...
            File theDir = new File(projectPath + ReadConfigPropertyFile.getPropValue("exportCapturePath"));
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(projectPath + ReadConfigPropertyFile.getPropValue("exportCapturePath") + "/" + screenName + "_" + dateFormat.format(new Date()) + ".png"));
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File(projectPath + ReadConfigPropertyFile.getPropValue("exportVideoPath") + "/" + methodName + "/");
